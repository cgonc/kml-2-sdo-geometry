# kml-2-sdo-geometry
A spring boot project for persisting KML files into SDO_GEOMETRY.
...
CREATE UNIQUE INDEX KML_SHAPE_PK ON AYDES.KML_SHAPE (ID);
...
For detailed instruction on adding spatial index you can check official documents.
https://docs.oracle.com/database/121/SPATL/toc.htm

After database setup you also need to setup your application.properties file.
...
After boot a Spring Component function will be scheduled to work. It will do the following things :
    ...
    2. For each unprocessed files :
        ...
        c. Convert JTS geometries into STRUCT and insert them to the table batchly.
